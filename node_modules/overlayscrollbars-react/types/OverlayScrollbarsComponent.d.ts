...
declare const OverlayScrollbarsComponent: <T extends keyof JSX.IntrinsicElements>(props: OverlayScrollbarsComponentBaseProps<T>, ref: React.ForwardedRef<OverlayScrollbarsComponentRef<T>>) => import("react/jsx-runtime").JSX.Element;
